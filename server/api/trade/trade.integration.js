...
describe('Trade API:', function() {
  ...
  describe('PUT /api/trades/:id', function() {
    ...
    it('should respond with the original trade', function() {
      expect(updatedTrade.name).to.equal('New Trade');
      expect(updatedTrade.info).to.equal('This is the brand new trade!!!');
    });
